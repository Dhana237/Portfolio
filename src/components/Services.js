...
const services = [
  {
    name:'Web Design',
    description:
    ' Lorem ipsum dolor sit amet consectetur adipising elit.Unde,numquam.Harum deleniti id sapiente sit amet consectetur adipising elit.',
     link: 'Learn more',
    ...
    <div className='flex flex-col lg:flex-row'>
      ...
      mix-blend-lighten mb-12 lg:mb-0'>
        ...
        <h3 className='h3 max-w-[455] mb-16'>
          I'm a Student who is learning React and Tailwind CSS to create website's
        </h3>
